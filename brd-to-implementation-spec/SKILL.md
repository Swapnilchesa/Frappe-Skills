...
description: >
  Convert a Business Requirements Document (BRD) into a complete, Claude Code-ready
  technical specification for Frappe Framework v16 projects with Flutter mobile apps.
  Use this skill whenever: someone provides a BRD/PRD and wants a technical spec,
  someone says "create a tech spec from this BRD", "convert requirements to spec",
  "make this Claude Code ready", "generate a Frappe spec from requirements", or
  any variation involving turning business requirements into an implementation-ready
  technical document. Also triggers when someone mentions building a Frappe + Flutter
  app and has requirements to work from. The output is a single Markdown document
  that Claude Code can execute across 5 build phases without additional context.
  ALWAYS use this skill when a BRD/PRD is provided and the goal is a Frappe tech spec.
---
